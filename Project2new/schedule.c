...
#ifdef PRINT_STATS
	printf("B: %d W: %d L: %d RUNNING: %d PID: %u \n", block_count, queue_count, loser_count, num_proc, pid );
#endif
	if(loser_count == 0) return -1;	
	return queue_count;
}
